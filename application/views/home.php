...
<!--     <div class="carousel-item active">
    ...
    <div class="carousel-item <?= ($img == 0) ? 'active' : '' ?>" style="background-image: url('<?= base_url()?>assets/img/slider/<?=$value?>')">
        ...
        <div class="carousel-caption d-block d-md-block animated bounceInDown" style="background:rgba(0,0,0,.5);padding:10px;margin-bottom: 200px;border-radius: 10px;box-shadow:1px 2px 4px black;">
        	<div style="margin: auto;">
				<img src="<?php echo base_url('assets/img/logo.png');?>" style="width:100%;max-width: 230px;height: 100px;">
			</div>
...
<div class="row headline aling-center" style="margin: auto; margin-top:60px;color: white;">
	...
	<div class="row">
		...
		<div class="container img_sesion_1">
			...
			<h4 class="text-white">Servicio</h4>
		</div>
		</div>
	</div>
	</div>
	...
	<div class="row">
		...
		<div class="container img_sesion_1">
			...
			<h4 class="text-white">Acesorios</h4>
		</div>
		</div>
	</div>
	</div>
...
<div class="parallax headline" style="margin-top: 70px;padding:20px;box-sizing:border-box;">
	<div class="row">
...
<div class="headline" style="margin-top: 40px;margin-bottom:60px; padding:20px;box-sizing:border-box;">
	<div class="row">
...
<div class="parallax2 headline" style="margin-top:50px;margin-bottom:50px;padding:20px;box-sizing:border-box;">
	<div class="row">
	<div class="col-sm-12 col-md-4 col-lg-4 aling-center">
		<div class="container img_sesion_2">
...
<footer class="headline">
	...
	<div class="container">
		...
		<div class="col-sm-12 col-md-7 col-lg-7 aling-center text-white">
...
<div class=" parallax2 col-sm-12 col-md-12 col-lg-12 aling-center" style="padding-top: 20px;padding-bottom:20px;margin-top:50px; background:;color:white;">
